...
static void impl_set_obj_fn(void);
...
static void impl_add_column(void)
{
        int m, count;
        int	*index;
	REAL	*vec;
...
static void impl_add_constraint(void)
{
        int type, n, count;
        int	*index;
	REAL	*vec, value;
...
static void impl_column_in_lp(void)
{
        int n;
	REAL	*vec;
...
static void impl_default_basis(void)
{
        Check_nrhs(cmd, 1, nrhs);
        default_basis(lp0);
}
...
static void impl_del_column(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_del_constraint(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_delete_lp(void)
{
        Check_nrhs(cmd, 1, nrhs);
        delete_handle(h);
}
...
static void impl_dualize_lp(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = dualize_lp(lp0);
...
static void impl_get_anti_degen(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_basis(void)
{
...
static void impl_get_basiscrash(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_bb_depthlimit(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_bb_floorfirst(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_bb_rule(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = get_bb_rule(lp0);
...
static void impl_get_bounds_tighter(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_break_at_value(void)
{
        Check_nrhs(cmd, 1, nrhs);
...
static void impl_get_col_name(void)
{
        char *name;
...
static void impl_get_column(void)
{
        int col;
...
static void impl_get_constr_type(void)
{
	if (nrhs == 1+1) {
                int i, m;
...
static void impl_get_constr_value(void)
{
        int n, count;
        int	*nzindex;
	REAL	*primsolution;
...
static void impl_get_constraints(void)
{
        Check_nrhs(cmd, 1, nrhs);
...
static void impl_get_dual_solution(void)
{
        int i;
	REAL	*vec = NULL;
...
static void impl_get_epsb(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
        *dpr = get_epsb(lp0);
...
static void impl_get_epsd(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
        *dpr = get_epsd(lp0);
...
static void impl_get_epsel(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
        *dpr = get_epsel(lp0);
...
static void impl_get_epsint(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
        *dpr = get_epsint(lp0);
...
static void impl_get_epsperturb(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_epspivot(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_improve(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = get_improve(lp0);
...
static void impl_get_infinite(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_lowbo(void)
{
	if (nrhs == 1+1) {
                int n, i;
...
static void impl_get_lp_index(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_lp_name(void)
{
        char *name;
...
static void impl_get_max_level(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_maxpivot(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_mip_gap(void)
{
        Check_nrhs(cmd, 2, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_nameindex(void)
{
        Check_nrhs(cmd, 3, nrhs);
        GetString(prhs, 2, buf, bufsz, TRUE);
...
static void impl_get_Ncolumns(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_negrange(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_nonzeros(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_Norig_columns(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_Norig_rows(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_Nrows(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = get_Nrows(lp0);
...
static void impl_get_obj_bound(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_obj_fn(void)
{
        int n;
	REAL	*vec;
...
static void impl_get_objective(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_objective_name(void)
{
        char *name;
...
static void impl_get_orig_index(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_origcol_name(void)
{
        char *name;
...
static void impl_get_origrow_name(void)
{
        char *name;
...
static void impl_get_pivoting(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_presolve(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_presolveloops(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_primal_solution(void)
{
        int i;
...
static void impl_get_print_sol(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_rh_range(void)
{
	if (nrhs == 1+1) {
                int m, i;
...
static void impl_get_row_name(void)
{
        char *name;
...
static void impl_get_scalelimit(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_scaling(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = get_scaling(lp0);
...
static void impl_get_sensitivity_objex(void)
{
        int n;
...
static void impl_get_sensitivity_rhsex(void)
{
        int i;
...
static void impl_get_simplextype(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_solution(void)
{
        int m, n;
        REAL *duals;
...
static void impl_get_solutioncount(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_solutionlimit(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_get_status(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = get_status(lp0);
...
static void impl_get_statustext(void)
{
        char *name;
...
static void impl_get_timeout(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = get_timeout(lp0);
...
static void impl_get_total_iter(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_total_nodes(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_upbo(void)
{
	if (nrhs == 1+1) {
                int n, i;
...
static void impl_get_var_branch(void)
{
	if (nrhs == 1+1) {
                int n, i;
...
static void impl_get_var_dualresult(void)
{
        Check_nrhs(cmd, 2, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_var_primalresult(void)
{
        Check_nrhs(cmd, 2, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_get_var_priority(void)
{
	if (nrhs == 1+1) {
                int n, i;
...
static void impl_get_variables(void)
{
        int n;
...
static void impl_get_verbose(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
	*ipr = get_verbose(lp0);
...
static void impl_get_working_objective(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_guess_basis(void)
{
        int i, n, m;
        REAL *guessvector;
...
static void impl_is_add_rowmode(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_anti_degen(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_binary(void)
{
        if (nrhs == 1+1) {
                int n, i;
...
static void impl_is_break_at_first(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_constr_type(void)
{
        Check_nrhs(cmd, 3, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_debug(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = is_debug(lp0);
...
static void impl_is_feasible(void)
{
        int i, n;
	REAL	*vec, threshold;
...
static void impl_is_infinite(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_integerscaling(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_maxim(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = is_maxim(lp0);
...
static void impl_is_nativeBFP(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_nativeXLI(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_negative(void)
{
        if (nrhs == 1+1) {
                int n, i;
...
static void impl_is_piv_mode(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_piv_rule(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_presolve(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_scalemode(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_scaletype(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_is_semicont(void)
{
        if (nrhs == 1+1) {
                int n, i;
...
static void impl_is_SOS_var(void)
{
        if (nrhs == 1+1) {
                int n, i;
...
static void impl_is_trace(void)
{
        Check_nrhs(cmd, 1, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = is_nativeXLI(lp0);
...
static void impl_is_use_names(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_lp_solve_version(void)
{
...
static void impl_resize_lp(void)
{
        Check_nrhs(cmd, 3, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_print_constraints(void)
{
        int n, columns;
...
static void impl_print_debugdump(void)
{
        char filename[260];
...
static void impl_print_duals(void)
{
        Check_nrhs(cmd, 1, nrhs);
	print_duals(lp0);
}
...
static void impl_print_lp(void)
{
        Check_nrhs(cmd, 1, nrhs);
	print_lp(lp0);
}
...
static void impl_print_objective(void)
{
        Check_nrhs(cmd, 1, nrhs);
	print_objective(lp0);
}
...
static void impl_print_scales(void)
{
        Check_nrhs(cmd, 1, nrhs);
	print_scales(lp0);
}
...
static void impl_print_solution(void)
{
        int n, columns;
...
static void impl_print_str(void)
{
        Check_nrhs(cmd, 2, nrhs);
        GetString(prhs, 2, buf, bufsz, TRUE);
        print_str(lp0, buf);
...
static void impl_print_tableau(void)
{
        Check_nrhs(cmd, 1, nrhs);
	print_tableau(lp0);
}
...
static void impl_print_handle(void)
{
        int i, j, k;
...
static void impl_get_handle(void)
{
        hashelem *hp;
...
static void impl_read_basis(void)
{
        char filename[260];
...
static void impl_read_freeMPS(void)
{
        int n, verbose;
        char filename[260];
...
static void impl_read_MPS(void)
{
        int n, verbose;
	...
	GetString(prhs, 1, filename, sizeof(filename), TRUE);
        if (n >= 2)
        	verbose = (int) GetRealScalar(prhs, 2);
                ...
                verbose = NORMAL;
        lp0 = read_MPS(filename, verbose);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
        *ipr = create_handle(lp0, "read_MPS can't read file.");
        name = get_lp_name(lp0);
        if (name != NULL)
                set_handlename(name, (int) *ipr);
        SetLongMatrix(ipr, 1, 1, plhs, 0, TRUE);
}
...
static void impl_read_params(void)
{
        int n;
...
static void impl_read_XLI(void)
{
        int n, verbose;
...
static void impl_reset_params(void)
{
        Check_nrhs(cmd, 1, nrhs);
        reset_params(lp0);
}
...
static void impl_set_add_rowmode(void)
{
        Check_nrhs(cmd, 2, nrhs);
        ipr = CreateLongMatrix(1, 1, plhs, 0);
...
static void impl_set_anti_degen(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_basis(void)
{
        int i, *bascolumn;
        MYBOOL nonbasic;
...
static void impl_set_basiscrash(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_basisvar(void)
{
        Check_nrhs(cmd, 3, nrhs);
...
static void impl_set_bb_depthlimit(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_bb_floorfirst(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_bb_rule(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_binary(void)
{
        if (nrhs == 1+2) {
                int i, n, *vec;
...
static void impl_set_bounds(void)
{
        if (nrhs == 1+3) {
                int i, n;
                REAL	*lower, *upper;
...
static void impl_set_bounds_tighter(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_break_at_first(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_break_at_value(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_col_name(void)
{
        if (nrhs == 1+2) {
                int n, i;
                strArray pa;
...
static void impl_set_column(void)
{
        int m, count;
        int	*index;
	REAL	*vec;
...
static void impl_set_constr_type(void)
{
        if (nrhs == 1+2) {
                int i, m, *vec;
...
static void impl_set_debug(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epsb(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epsd(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epsel(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epsint(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epslevel(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epsperturb(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_epspivot(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_free(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_improve(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_infinite(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_lowbo(void)
{
        if (nrhs == 1+2) {
                int i, n;
                REAL *vec;
...
static void impl_set_lp_name(void)
{
        Check_nrhs(cmd, 2, nrhs);
        GetString(prhs, 2, buf, bufsz, TRUE);
...
static void impl_set_maxim(void)
{
        Check_nrhs(cmd, 1, nrhs);
        set_maxim(lp0);
}
...
static void impl_set_maxpivot(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_minim(void)
{
        Check_nrhs(cmd, 1, nrhs);
        set_minim(lp0);
}
...
static void impl_set_mip_gap(void)
{
        Check_nrhs(cmd, 3, nrhs);
...
static void impl_set_negrange(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_obj_bound(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_outputfile(void)
{
        char filename[260];
...
static void impl_set_pivoting(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_preferdual(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_presolve(void)
{
        int maxloops;
...
static void impl_set_print_sol(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_rh_range(void)
{
        if (nrhs == 1+2) {
                int i, m;
                REAL *vec;
...
static void impl_set_rh_vec(void)
{
        int m;
	REAL	*vec;
...
static void impl_set_row_name(void)
{
        if (nrhs == 1+2) {
                int m, i;
                strArray pa;
...
static void impl_set_scalelimit(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_scaling(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_semicont(void)
{
        if (nrhs == 1+2) {
                int i, n, *vec;
...
static void impl_set_sense(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_simplextype(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_solutionlimit(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_timeout(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_trace(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_set_upbo(void)
{
        if (nrhs == 1+2) {
                int i, n;
                REAL *vec;
...
static void impl_set_use_names(void)
{
        Check_nrhs(cmd, 3, nrhs);
...
static void impl_set_var_branch(void)
{
        if (nrhs == 1+2) {
                int i, n, *vec;
...
static void impl_set_var_weights(void)
{
        int n;
	REAL	*vec;
...
static void impl_set_verbose(void)
{
        Check_nrhs(cmd, 2, nrhs);
...
static void impl_time_elapsed(void)
{
        Check_nrhs(cmd, 1, nrhs);
        dpr = CreateDoubleMatrix(1, 1, plhs, 0);
...
static void impl_write_basis(void)
{
        char filename[260];
...
static void impl_write_freemps(void)
{
        char filename[260];
...
static void impl_write_lp(void)
{
        char filename[260];
...
static void impl_write_mps(void)
{
        char filename[260];
...
static void impl_write_params(void)
{
        int n;
        char filename[260], options[50];
...
static void impl_write_XLI(void)
{
        char filename[260], options[50];
        int n;
        MYBOOL results;
